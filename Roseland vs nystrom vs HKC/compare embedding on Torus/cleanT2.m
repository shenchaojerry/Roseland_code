%% 5000 clean data points with 200 clean landmarks
...
scatter3(data(:, 1), data(:, 2), data(:, 3), 18, c, 'filled'); axis tight;
...
axis off
%title('Torus and subset','fontsize', 20)
...
figure('Renderer', 'painters', 'Position', [10 10 1200 700]);
scatter3(Ux(:, 1), Ux(:, 2), Ux(:, 3), 30, c(x>0), 'filled'); axis tight;
xlabel('X', 'fontsize', 40); ylabel('Y', 'fontsize', 40); zlabel('Z', 'fontsize', 40)
%ax = gca; ax.FontSize = 40; 
axis off
...
figure('Renderer', 'painters', 'Position', [10 10 1200 700]);
scatter3(Uz(:, 1), Uz(:, 2), Uz(:, 3), 30, c(z>0), 'filled'); axis tight;
xlabel('X', 'fontsize', 40); ylabel('Y', 'fontsize', 40); zlabel('Z', 'fontsize', 40)
ax = gca; ax.FontSize = 40; 
%title('Torus horizontal cut','fontsize', 20)

%% DM
[U1, ~] = DiffusionMap(data, 0, 3, 100, 1);
figure('Renderer', 'painters', 'Position', [10 10 1200 700]);
